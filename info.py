...
API_ID = int(environ['22146103'])
API_HASH = environ['c3e0762b58f2c5fa4a2192f7c69b420e']
BOT_TOKEN = environ['8108550750:AAEzeXr1RAeb5wxWddg_dNo5IP8ANrZBwYA']
...
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '7244446698').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
auth_channel = environ.get('-1002344221556')
auth_grp = environ.get('-1002497196733')
...
# LOG CHANNELS *
LOG_CHANNEL = int(environ.get('-1002486915650', 0))
LAZY_GROUP_LOGS = int(environ.get('-1002497196733', 0))
REQ_CHANNEL = int(environ.get('-1002471769680'))
